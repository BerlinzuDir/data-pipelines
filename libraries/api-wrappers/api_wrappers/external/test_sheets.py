    ...
    return pd.DataFrame(
        {
            ...
            "name": [
                'Aromatisierter Vodka "Green Mark Rye" 40% vol.',
                'Aromatisierter Vodka "Imperial Collection Gold" 40% vol'
            ],
            "ru name": [
                'Aроматизированная водка "Зеленая Марка", Ржаная" 40% алк.',
                'Водка "Imperial Collection Gold" 40% алк.'
            ],
            "price": [7.99, 11.59],
            "tax": [19] * 2,
            "weight": [0.5] * 2,
            ...
            "supplier": ['Monolith'] * 2,
            "pic": [
                'https://catalog.stolitschniy.shop/static/img/products/normalized/4600893900492.jpg',
                'https://catalog.stolitschniy.shop/static/img/products/normalized/4603514007105.jpg'
            ],
