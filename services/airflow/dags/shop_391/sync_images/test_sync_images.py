...
def test_load_images_to_sftp(_decorate_load_product_data, _sftp_cleanup):
    ...
    assert (
        products["Produktbild \n(Dateiname oder url)"].iloc[0] == "http://s739086489.online.de/bzd-bilder/bzd/391/1.jpg"
    )
