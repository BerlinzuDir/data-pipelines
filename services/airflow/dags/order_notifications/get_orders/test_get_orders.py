...
@vcr.use_cassette("dags/order_notifications/get_orders/cassettes/authentication_token.yaml")
...
@vcr.use_cassette("dags/order_notifications/get_orders/cassettes/authentication_token.yaml")
@vcr.use_cassette(
    "dags/order_notifications/get_orders/cassettes/tour_overview.yaml",
...
@vcr.use_cassette("dags/order_notifications/get_orders/cassettes/authentication_token.yaml")
@vcr.use_cassette(
    "dags/order_notifications/get_orders/cassettes/pickup_overview.yaml",
    record_mode=RECORD_MODE,
)
def test_pickup_overview_returns_json_with_orders():
    ...
    # pprint(get_pickup_overview(token, 50, 287, "17:00"))
    # pprint(get_pickup_overview(token, 50, 287, "19:00"))
    # pprint(get_pickup_overview(token, 50, 409, "17:00"))
    # pprint(get_pickup_overview(token, 50, 409, "19:00"))
    pickup = get_pickup_overview(token, 50, 287, "17:00")
    pprint(pickup)
...
@vcr.use_cassette("dags/order_notifications/get_orders/cassettes/authentication_token.yaml")
@vcr.use_cassette(
    "dags/order_notifications/get_orders/cassettes/dropoff_overview.yaml",
    record_mode=RECORD_MODE,
)
